		...
		<div class="form-row">
			<div class="col-sm-3">
				<div class="form-group">	
					...
					<input type="search" autocomplete="off" name="i" value="<?= $i ?>" class="form-control">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">	
					<label><b>Data GET</b></label><br>
					<input type="search" autocomplete="off" value="<?= $get  ?>" name="data" class="form-control">	
				</div>
			</div>
				...
				<div class="form-group">	
					...
					<div class="form-group">
						<div class="input-group flex-nowrap ">
							...
							<input type="search" autocomplete="off" value="<?= $tgl_awal ?>" class="form-control " name="tgl_awal">	
						</div>
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="form-group">
						<div class="input-group flex-nowrap">
							...
							<input type="search" class="form-control" autocomplete="off" value="<?= $tgl_akhir ?>" name="tgl_akhir" >
						</div>
					</div>
				</div>
			</div>
